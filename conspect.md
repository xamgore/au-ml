...
> 98 стр. | [Воронцов](http://www.machinelearning.ru/wiki/images/5/53/Voron-ML-Lin-SG.pdf)  4
...
### Байесовский классификатор. Типы оценки распределений признаков (Gaussian, Bernoulli, Multinomial). EM алгоритм.

<mark>пояснить за free lunch
